...
fake_users_db = {
    "carlos@teste.pt": {
        ...
        "id": 7,
        "id_org":2,
        "username": "tomas@teste.pt",
        "full_name": "Nuno Tomas",
        "email": "tomas@teste.pt",
        "hashed_password": "$2b$12$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW",
        "disabled": False,
        "roles": ["admin","tecnico"],
    }, "probi_farmer@teste.pt": {
        "id": 4,
        "id_org":1,
        "username": "probi_farmer@teste.pt",
        "full_name": "Probi Farmer",
        "email": "probi_farmer@teste.pt",
        "hashed_password": "$2b$12$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW",
        "disabled": False,
        "roles": ["admin","tecnico"],
    },"pombo@teste.pt": {
        "id": 2,
        "id_org":2,
        "username": "pombo@teste.pt",
        "full_name": "Nuno Pombo",
        "email": "pombo@teste.pt",
        "hashed_password": "$2b$12$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW",
        "disabled": False,
        "roles": ["admin","tecnico"],
    },
